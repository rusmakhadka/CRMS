...
<?php session_start(); ?>
    ...
    <!-- MetisMenu CSS -->
    <link href="/criminal/admin/assets/vendor/metisMenu/metisMenu.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="/criminal/admin/assets/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="/criminal/admin/assets/vendor/morrisjs/morris.css" rel="stylesheet">
